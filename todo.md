...
## 修正：AI 通常回答ボックスのマークダウン記法対応
- [x] AI プロンプトを修正してマークダウン記法を使わないよう注意書きを追加
- [x] AIChatBox コンポーネントで通常回答に Streamdown を適用（既に実装済み）
- [x] ブラウザでテストして、マークダウン記法と数式が正しくレンダリングされることを確認
